              ...
              child: Row(
                ...
                children: [
                  IconButton(
                    ...
                    icon: Icon(
                      Icons.arrow_back,
                      color: controller.currentIndex == 0 ? Colors.grey : Colors.black,
                    ),
                  ),
                  Container(color: const Color(0xFFE4E6EA), width: 1, height: 24),
                  IconButton(
                    onPressed: controller.nextQuestions,
                    icon: Icon(
                      Icons.arrow_forward,
                      color: controller.currentIndex == controller.totalQuestions - 1 ? Colors.grey : Colors.black,
                    ),
                  ),
                ],
              ),
