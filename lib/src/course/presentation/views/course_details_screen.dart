          ...
          child: ListView(
            ...
            children: [
              SizedBox(
                ...
                child: Center(
                  child: course.image != null ? Image.network(course.image!) : Image.asset(MediaRes.casualMeditation),
                ),
              ),
              ...
              Column(
                ...
                children: [
                  ...
                  if (course.description != null) ExpandableText(text: course.description!, context: context),
