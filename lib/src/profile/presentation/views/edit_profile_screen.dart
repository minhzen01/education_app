...
import 'package:education_app/src/profile/presentation/views/widgets/edit_profile_form.dart';
                ...
                onPressed: () {
                  ...
                  if (passwordChanged) {
                    if (oldPasswordController.text.isEmpty) {
                      CoreUtils.showSnackBar(context, 'Please enter your old password');
                      return;
                    }
                    bloc.add(
                      UpdateUserEvent(
