...
import 'package:education_app/src/chat/presentation/components/chat_app_bar.dart';
    ...
    return Scaffold(
      ...
      body: BlocConsumer<ChatCubit, ChatState>(
        ...
        builder: (context, state) {
          ...
          } else if (state is MessagesLoaded || showInputField || messages.isNotEmpty) {
            return Column(
              children: [
                Expanded(
                  child: ListView.builder(
                    ...
                    itemBuilder: (_, index) {
                      ...
                      final showSenderInfo = previousMessage == null || previousMessage.senderId != message.senderId;
                      return BlocProvider(
